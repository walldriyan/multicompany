                              ...
                              <AccordionTrigger className="p-0 hover:no-underline text-base font-semibold flex-col items-start !space-y-2">
                                <div className="flex justify-between items-start w-full">
                                  ...
                                  <div className="flex items-end gap-2">
                                    <h2 className="text-4xl font-bold  text-red-400">Rs. {billFinancials.finalBalance.toFixed(2)} <span className="text-lg font-medium">Due</span></h2>
                                    <div className="flex items-center text-green-400 text-sm font-medium">
                                      <ArrowUpRight className="w-4 h-4 mr-1" />
                                      Rs. {billFinancials.totalPaidByCustomer.toFixed(2)} PAID
                                    </div>
                                    <div className="flex items-center text-primary text-sm font-medium">
                                      <ArrowUpRight className="w-4 h-4 mr-1" />
                                      OF Rs. Rs. {billFinancials.netBillAmount.toFixed(2)}
                                    </div>
                                  </div>
